...
import { getOAuthClientForRequest } from "./google-auth.js";
...
export const DRIVE_BUILD = "2026-07-22-multi-google-oauth";
...
/** Drive API authentifiée avec le compte Google de la requête (cookie) ou fallback env. */
